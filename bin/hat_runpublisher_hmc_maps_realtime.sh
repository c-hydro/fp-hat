...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HAT - Run Publisher - Maps - REALTIME'
...
# Execution example:
# python HAT_RunPublisher_HMC_Maps.py -settings_file hat_runpublisher_hmc_maps.json -time "2020-11-02 12:00"
#-----------------------------------------------------------------------------------------

#-----------------------------------------------------------------------------------------
# Get file information
flag_run_publisher=true
script_file_publisher='/hydro/library/fp_package_hat/apps/Analyzer_Datasets/maps/HAT_RunPublisher_HMC_Maps.py'
settings_file_publisher='/hydro/fp_tools_postprocessing/analyzer_datasets/hat_runpublisher_hmc_maps_realtime.json'
