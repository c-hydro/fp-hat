#!/usr/bin/python3
"""
Hydrological Analysis Tool - App Q percentile
...
python app_q_percentile_main.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20241031 (1.0.0) --> Operational Release
"""
...
def main():
    ...
    time_run, time_range = set_time_info(
    ...
    driver_data_static = DriverStatic(
        ...
        flag_clean_static=data_settings['algorithm']['flags']['clean_static']
    )
    ...
    file_collection = driver_data_dynamic.organize_dynamic()
    driver_data_dynamic.dump_dynamic(file_collection)
    # ------------------------------------------------------------------------------------------------------------------
