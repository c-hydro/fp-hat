...
python HAT_DataPublisher_HMC_NRT.py -settingfile hat_datapublisher_hmc_nrt_configuration.json -time YYYYMMDDHHMM

Version:
20190527 (1.5.1) --> Add soil moisture and accumulated rain to time-series graph(s)
20190516 (1.5.0) --> Fix bugs in data seeking and data plotting (hydrapp time-series and maps product)
20190322 (1.0.1) --> Beta release
20190219 (1.0.0) --> Starting development
"""
# -------------------------------------------------------------------------------------
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'hat_datapublisher_hmc_nrt_configuration.json'
