...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP ENVIRONMENT - PYTHON3 LIBRARIES FOR HAT PACKAGE - CONDA'
...
fp_env_tag_default='hat'

fp_env_folder_root_default='/home/fabio/Desktop/Documents/Work_Area/Code_Development/Workspace/HAT_Workspace/conda/'
